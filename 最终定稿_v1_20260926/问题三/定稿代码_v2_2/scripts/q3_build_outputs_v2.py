...
def main() -> None:
    ...
    if (
        frozen_parameters.get("schema") != "q3v2.2-explanation-freeze-v1"
        or frozen_parameters.get("status") != "frozen"
    ):
    ...
    manifest: Dict[str, Any] = {
        ...
        "limitations": [
            ...
            mapping_limitation,
            "Window size is selected only from validation by symmetric per-pattern top-vs-top, budget-normalized fidelity with video-group clustered confidence intervals.",
        ],
    }
