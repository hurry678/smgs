...
def main() -> None:
    ...
    manifest: Dict[str, Any] = {
        ...
        "packager_script": "scripts/q3_build_outputs.py",
        "packager_script_sha256": sha256_file(Path(__file__)),
        "explanation_parameters": "artifacts/q3/freeze_parameters.json",
        "explanation_parameters_sha256": sha256_file(Path("artifacts/q3/freeze_parameters.json")),
        "inputs": {
            "data": str(args.data),
