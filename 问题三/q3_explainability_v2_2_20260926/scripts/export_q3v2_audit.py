#!/usr/bin/env python3
"""Create and self-check a portable Q3 v2.2 audit archive."""
...
def main() -> None:
    ...
    archive_path = args.export_dir / "q3_explainability_v2_2_audit.zip"
    ...
    required = {
        ...
        "source/scripts/compare_q3v2_2_results.py",
