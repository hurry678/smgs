#!/usr/bin/env python3
"""Q3 v2.2 faithful explanation core for the frozen M3-ensemble9 predictor.
...
def top_support_fidelity(
    ...
    """Apply the v2.2 symmetric top-vs-top fidelity comparison."""
    return dict(symmetric_top_support_fidelity(records, sample_ids, seed))
...
def run_validation(args: argparse.Namespace, device: torch.device) -> None:
    ...
    report = {
        ...
        "protocol": {
            ...
            "top_support_comparison": "independent per-pattern maximum of signed class delta per actual masked position",
