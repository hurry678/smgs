#!/usr/bin/env python3
"""Select and freeze Q3 local-evidence parameters from validation reports."""
...
def main() -> None:
    ...
    freeze = {
        "schema": "q3v2-explanation-freeze-v1",
        "status": "frozen",
        ...
        "selection_metric": "mean_budget_normalized_top_support",
        "selection_gate": (
            "lower bound of video-group clustered 95% CI > 0 against both "
            "same-budget random-contiguous and point-scatter controls"
        ),
